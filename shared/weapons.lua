...
QBShared.Weapons = {
	...
	-- Blackmarket
	[`weapon_ak47`] = { name = 'weapon_ak47', label = 'AK-47', caliber = '7.62x39mm NATO', weapontype = 'Assault Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored' },
	[`weapon_m70`] = { name = 'weapon_m70', label = 'M70', caliber = '7.62x39mm NATO', weapontype = 'Assault Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored' },
	...
	[`weapon_mossberg`] = { name = 'weapon_mossberg', label = 'Mossberg 500', caliber = '12 gauge shell', weapontype = 'Shotgun', ammotype = 'AMMO_SHOTGUN', damagereason = 'Devastated / Pulverized / Shotgunned' },
	...
	[`weapon_hk416`] = { name = 'weapon_hk416', label = 'HK-416', caliber = '7.62x51mm NATO', weapontype = 'Assault Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored' },
	...
	[`weapon_m4`] = { name = 'weapon_m4', label = 'PD M4A1', caliber = '7.62x51mm NATO', weapontype = 'Assault Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored' },
	[`weapon_ar15`] = { name = 'weapon_ar15', label = 'PD AR-15', caliber = '7.62x51mm NATO', weapontype = 'Assault Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored' },
	[`weapon_remington`] = { name = 'weapon_remington', label = 'Remington 870', caliber = '12 gauge shell', weapontype = 'Shotgun', ammotype = 'AMMO_SHOTGUN', damagereason = 'Devastated / Pulverized / Shotgunned' },
	[`weapon_scarh`] = { name = 'weapon_scarh', label = 'PD SCAR-H', caliber = '7.62x51mm NATO', weapontype = 'Assault Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored' },
